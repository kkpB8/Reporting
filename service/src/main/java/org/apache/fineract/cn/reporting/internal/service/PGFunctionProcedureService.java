...
//                geographicalCoverage.setNoofshg_la(rs.getInt("noofshg_la"));
//                geographicalCoverage.setNoofleaders_la(rs.getInt("noofleaders_la"));
//                geographicalCoverage.setAgriactivity(rs.getInt("agriactivity"));
//                geographicalCoverage.setLivestock_fisheries(rs.getInt("livestock_fisheries"));
//                geographicalCoverage.setNtfp(rs.getInt("ntfp"));
//                geographicalCoverage.setNon_farm(rs.getInt("non_farm"));
