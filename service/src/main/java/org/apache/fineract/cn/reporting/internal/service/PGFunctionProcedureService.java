    ...
    public List<TblSummaryResponse> fn_gettblsummarydata(String reportName, String locationType, String dateTo, String dateFrom, String stateId, String districtId,
        ...
        try {
            ...
            while (rs.next()) {
                ...
                geographicalCoverage.setApproved_shg(rs.getInt("approved_shg"));
                geographicalCoverage.setInactive_shg(rs.getInt("inactive_shg"));
                geographicalCoverage.setInactive_shg_members(rs.getInt("inactive_shg_members"));
                geographicalCoverage.setApproved_vo(rs.getInt("approved_vo"));
                geographicalCoverage.setInactive_vo(rs.getInt("inactive_vo"));
                geographicalCoverage.setApproved_clf(rs.getInt("approved_clf"));
                geographicalCoverage.setInactive_clf(rs.getInt("inactive_clf"));
                ...
                geographicalCoverage.setTotal_shg(rs.getInt("total_shg"));
                geographicalCoverage.setTarget_shg_members(rs.getInt("target_shg_members"));
                geographicalCoverage.setTotal_vo(rs.getInt("total_vo"));
                geographicalCoverage.setTotal_vo_shg(rs.getInt("total_vo_shg"));
                geographicalCoverage.setTotal_vo_members(rs.getInt("total_vo_members"));
                geographicalCoverage.setTotal_clf(rs.getInt("total_clf"));
                geographicalCoverage.setTotal_clf_vo(rs.getInt("total_clf_vo"));
                geographicalCoverage.setTotal_clf_shg(rs.getInt("total_clf_shg"));
                geographicalCoverage.setTotal_clf_members(rs.getInt("total_clf_members"));
                geographicalCoverage.setNoclfs(rs.getInt("noclfs"));
                geographicalCoverage.setBanklinkage_clf(rs.getInt("banklinkage_clf"));
                geographicalCoverage.setAssestver_clf(rs.getInt("assestver_clf"));
                geographicalCoverage.setLivlihoodprom_clf(rs.getInt("livlihoodprom_clf"));
                geographicalCoverage.setMonitoring_clf(rs.getInt("monitoring_clf"));
                ...
                geographicalCoverage.setTotal_rural_households(rs.getInt("total_rural_households"));
                geographicalCoverage.setTarget_rural_households(rs.getInt("target_rural_households"));
                geographicalCoverage.setHousehold_mobilized(rs.getInt("household_mobilized"));
//                geographicalCoverage.setTotal_shg_mel(rs.getInt("total_shg_mel"));
//                geographicalCoverage.setTarget_shg_members(rs.getInt("total_shg_members"));
