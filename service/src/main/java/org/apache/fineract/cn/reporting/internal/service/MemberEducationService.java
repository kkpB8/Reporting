...
public class MemberEducationService {
    ...
    @Autowired
    public MemberEducationService(@Qualifier(ServiceConstants.LOGGER_NAME) final Logger logger,
    ...
    public List<MemberEducationReponse> getmembereducation(String location_type, String sid, String did,
                                                   String bid, String tenantIdentifier) {
        return pgFunctionProcedureService.fn_getmembereducation(location_type,sid, did, bid, tenantIdentifier);
    }
}
