...
public class ShgInitiativeResponse {
    ...
    private String cumlshg;
    private String cumlmember;
    ...
    public String getCumlshg() {
        return cumlshg;
    }

    public void setCumlshg(String cumlshg) {
        this.cumlshg = cumlshg;
    }

    public String getCumlmember() {
        return cumlmember;
    }

    public void setCumlmember(String cumlmember) {
